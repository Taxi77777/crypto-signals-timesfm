...
Rejoue jusqu'a 2 ans d'historique BITCOIN (bougies 1h) : a chaque fenetre, les 5 IA
...
PERIOD   = os.getenv("WARMUP_PERIOD", "60d")   # 60 jours max pour 30m/15m
INTERVAL = os.getenv("WARMUP_INTERVAL", "30m")
STEP     = int(os.getenv("WARMUP_STEP", "1"))   # 1 fenetre toutes les 30 min (pour bougies 30m)
