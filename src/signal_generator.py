...
def generate_signal(
    ...
    try:
        ...
        # Filtre Volume désactivé en temps réel car la bougie en cours a toujours un volume faible avant clôture
        ...
        # Mode Impulsion Bi-directionnel (BUY & SELL autorisés)
